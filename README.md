...
| --- | --- | --- |
| 👑 **황세원**<br>`SW313131` | Project Leader | • 팀 리딩 및 프로젝트 일정·진행 관리<br>• 서비스 기획 및 발표/문서 작성(자료 조사 및 자료 정확성 확인)<br>• Figma UI/UX 디자인 참여 |
...
| **김유진**<br>`yj2157` | Planner / UI·UX Designer | • 서비스 핵심 아이디어 기획, 컨셉 수립 및 자료조사<br>• Figma UI/UX 디자인 및 앱 아이콘 디자인<br>• 주거 탭, 더보기 탭 UI/기능 보완 참여|
---
